            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
              <div className="flex items-center">
                <div className="w-full">
                  <h4 className="text-indigo-200 text-base font-medium leading-6 mb-4 text-center lg:text-left">
                    Contact Us
                  </h4>
                  <h2 className="text-gray-100 font-manrope text-4xl font-semibold leading-10 mb-9 text-center lg:text-left">
                    Reach Out To Us
                  </h2>
                  <form onSubmit={formik.handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        name="firstName"
                        className={`w-full h-14 shadow-sm text-gray-600 placeholder-gray-400 text-lg font-normal leading-7 rounded-full border ${
                          formik.touched.firstName && formik.errors.firstName
                            ? "border-red-500"
                            : "border-gray-200"
                        } focus:outline-none focus:ring-2 focus:ring-indigo-500 py-2 px-4`}
                    ...
                    <div>
                      ...
                      <textarea
                        name="message"
                        className={`w-full h-48 shadow-sm resize-none text-gray-600 placeholder-gray-400 text-lg font-normal leading-7 rounded-2xl border ${
                          formik.touched.message && formik.errors.message
                            ? "border-red-500"
                            : "border-gray-200"
                        } focus:outline-none focus:ring-2 focus:ring-indigo-500 px-4 py-4`}
                        placeholder="Message"
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <button
                      type="submit"
                      className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-indigo-600 shadow transition-all duration-300 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      Submit
                    </button>
                  </form>
                </div>
              </div>
              <div class="lg:max-w-xl w-full h-[600px] flex items-center justify-center mt-28  bg-cover bg-no-repeat bg-[url('https://pagedone.io/asset/uploads/1696245837.png')] ">
                <div class="">
